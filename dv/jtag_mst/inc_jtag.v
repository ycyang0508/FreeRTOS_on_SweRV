...
event jtag_rst_start_e;
event jtag_rst_end_e;
task jtag_rst;
  integer halfperiod;
  begin
  ->jtag_rst_start_e;
...
event jtag_hard_rst_start_e;
event jtag_hard_rst_end_e;

task jtag_hard_rst;
  integer halfperiod;
  begin
  ->jtag_hard_rst_start_e;
...
event jtag_selectir_start_e;
event jtag_selectir_end_e;
...
event jtag_senddr_start_e;
event jtag_senddr_end_e;
