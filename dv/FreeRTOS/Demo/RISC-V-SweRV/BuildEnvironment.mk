...
SDK_DIR = ./sdk
SWERV_DIR = /home/ycyang/working/riscv_test/rtl/swerv_eh1/configs/snapshots/default/

LINKER_SCRIPT = $(SDK_DIR)/env/swerv_eh1/flash.lds
#-----------------------------------------------------------
...
LDFLAGS :=  -Xlinker --gc-sections -Xlinker 
LDFLAGS += -O0 -g3
